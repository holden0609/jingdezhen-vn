...
monogatari.script ({
    ...
    'Story_scene110': [
        ...
        'y 這、這裡是……哪裡？',
        'g 這裡靈魂的交匯之地，命運的轉折點！',
        'g 至於你為什麼會來到這邊嘛，其實是因為有一個非你不可的任務在等著你！',
    ...
    'choice_burn_right': [
        ...
        'm 這第關考驗，便算你實至名歸地通過了！接著去準備下一項挑戰吧！',
    ...
    'Label_ExploreRoute_Start': [        
        ...
        'w 啊！我知道你，你便是那黃毛小兒。吾乃汪大人，若無我之存在，御器廠的絕世手藝，就成了明珠投暗了！',
        'w 今日你來，便是想要我這「大師」替你講解這瓷器的欣賞與分類吧？',
        'y 望大人不計身分，指點一二！',
        'w 想在景德鎮混口飯吃，可得先分得清「釉下彩」、「釉上彩」與「單色釉」',
        'w 要是連這都分不清，那可就跟俗物無異啦。',
        'y 釉下、釉上、單色釉……這我當然懂！不過，能斗膽請大人拿實物說明一番嗎？', 
        'w 得咧！今日便讓你開開眼界！',
        '於是，你們一同走向了倉儲區',
...
'choice_see_right': [
    ...
    'Label_MerchantRoute_Start': [
        ...
        galleryOverlay.innerHTML = `
            <div class="gallery-box">
                <div class="gallery-title">🏛️ 明朝外銷瓷器大觀 🏛️</div>
                <div class="gallery-subtitle">點擊各尊瓷器仔細鑑賞，全數觀摩完畢後方可繼續前進</div>
...
'jump Label_Ask_sale'
    ...
    'choice_sale_right': [
        ...
        'y 呼……好險！手真酸啊，終於把都成功了！',
        's 哈哈哈！做的好！骨肉調和，手藝精進！這才是大明瓷器像樣的推廣者！',
        's 這第關考驗，便算你實至名歸地通過了！接著去準備下一項挑戰吧！',
